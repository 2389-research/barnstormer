# barnstormer Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Build barnstormer — a local-first, web-based, agentic spec workstation that drives discovery through questions, renders specs as cards + document, and emits Markdown/YAML/DOT artifacts.

**Architecture:** Rust workspace with 4 library crates (barnstormer-core, barnstormer-store, barnstormer-server, barnstormer-agent) and a thin binary. Event-sourced via append-only JSONL with SQLite cache. Per-spec actor model for concurrency. Server-rendered web UI via Axum + Askama + HTMX + SSE.
...
- Create: `crates/barnstormer-core/Cargo.toml`
- Create: `crates/barnstormer-core/src/lib.rs`
- Create: `crates/barnstormer-store/Cargo.toml`
- Create: `crates/barnstormer-store/src/lib.rs`
- Create: `crates/barnstormer-server/Cargo.toml`
- Create: `crates/barnstormer-server/src/lib.rs`
- Create: `crates/barnstormer-agent/Cargo.toml`
- Create: `crates/barnstormer-agent/src/lib.rs`
- Modify: `src/main.rs` (import and call barnstormer-server)
...
barnstormer-core = { path = "crates/barnstormer-core" }
barnstormer-store = { path = "crates/barnstormer-store" }
barnstormer-server = { path = "crates/barnstormer-server" }
barnstormer-agent = { path = "crates/barnstormer-agent" }
...
[dependencies]
barnstormer-server.workspace = true
...
```
feat: scaffold workspace with barnstormer-core, barnstormer-store, barnstormer-server, barnstormer-agent crates
```
...
**Files:**
- Create: `crates/barnstormer-core/src/model.rs`
- Create: `crates/barnstormer-core/src/card.rs`
- Test: `crates/barnstormer-core/src/model.rs` (inline tests)
...
Run: `cargo test -p barnstormer-core`
...
**Files:**
- Create: `crates/barnstormer-core/src/event.rs`
- Create: `crates/barnstormer-core/src/command.rs`
...
**Files:**
- Create: `crates/barnstormer-core/src/state.rs`
- Test: inline tests
...
**Files:**
- Create: `crates/barnstormer-store/src/jsonl.rs`
- Test: inline tests (using tempdir)

Dependencies to add to barnstormer-store: `tempfile` (dev-dependency)
...
**Files:**
- Create: `crates/barnstormer-store/src/snapshot.rs`
- Test: inline tests
...
**Files:**
- Create: `crates/barnstormer-core/src/actor.rs`
...
- Create: `crates/barnstormer-server/src/routes.rs`
- Create: `crates/barnstormer-server/src/app_state.rs`
- Modify: `src/main.rs`
...
`AppState` holds: map of `spec_id → SpecActorHandle`, `barnstormer_home` path, config.

Router: `GET /health`, and static file serving for HTMX/CSS.

`src/main.rs`: CLI with clap (`start`, `status` subcommands), dotenvy for config, bind to `BARNSTORMER_BIND` (default `127.0.0.1:7331`).
...
**Files:**
- Create: `crates/barnstormer-server/src/api/specs.rs`
- Create: `crates/barnstormer-server/src/api/mod.rs`
...
**Files:**
- Create: `crates/barnstormer-server/src/api/commands.rs`
...
**Files:**
- Create: `crates/barnstormer-server/src/api/stream.rs`
...
- Create: `crates/barnstormer-server/src/web/mod.rs`
...
**Files:**
- Create: `crates/barnstormer-core/src/export/mod.rs`
- Create: `crates/barnstormer-core/src/export/markdown.rs`
- Test: inline tests
...
**Files:**
- Create: `crates/barnstormer-core/src/export/yaml.rs`
...
**Files:**
- Create: `crates/barnstormer-core/src/export/dot.rs`
...
**Files:**
- Create: `crates/barnstormer-agent/src/runtime.rs`
- Create: `crates/barnstormer-agent/src/tools.rs`
...
**Files:**
- Create: `crates/barnstormer-agent/src/providers/mod.rs`
- Create: `crates/barnstormer-agent/src/providers/anthropic.rs`
...
**Files:**
- Create: `crates/barnstormer-agent/src/providers/openai.rs`
- Create: `crates/barnstormer-agent/src/providers/gemini.rs`
...
**Files:**
- Create: `crates/barnstormer-agent/src/swarm.rs`
...
**Files:**
- Create: `crates/barnstormer-agent/src/context.rs`
...
**Files:**
- Create: `crates/barnstormer-store/src/sqlite.rs`
...
**Files:**
- Modify: `crates/barnstormer-store/src/jsonl.rs`
- Create: `crates/barnstormer-store/src/recovery.rs`
...
**Files:**
- Create: `crates/barnstormer-store/src/manager.rs`
- Modify: `src/main.rs`

**Step 1: Implement StorageManager**

- Initializes `BARNSTORMER_HOME` directory structure
...
`barnstormer start`: init storage → recover specs → start actors → start HTTP server → open browser (unless --no-open).
...
**Files:**
- Create: `crates/barnstormer-server/src/config.rs`
- Create: `.env.example`

**Step 1: Implement config loading**

Read all env vars from spec Section 11. Validate: if `BARNSTORMER_ALLOW_REMOTE=true`, require `BARNSTORMER_AUTH_TOKEN`.
